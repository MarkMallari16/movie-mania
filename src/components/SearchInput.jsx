    ...
    return (
        <>
            <input type="text" value={currentQuery} onChange={onHandleQueryChange} onKeyDown={onHandleSearchEnter} className='input input-ghost bg-none w-full pl-12' placeholder='Search movies here...' />
            {
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className=" absolute size-6 top-3 end-4 cursor-pointer bg-base-300 rounded-lg p-1" onClick={onClearQuery} data-tip="clear">
