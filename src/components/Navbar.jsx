    ...
    return (
        <div className="navbar">
            <div className='w-full flex justify-between'>
                ...
                <div className='w-full  relative' onClick={() => setIsInputHide(!isInputHide)}>
                    ...
                    <input type="text" placeholder="Type here" className={`input input-bordered w-full pl-12 max-w-sm`} />
