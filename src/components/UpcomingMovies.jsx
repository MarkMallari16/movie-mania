        ...
        <div className='mx-20'>
            ...
            <div className='rounded-box flex flex-wrap gap-8 justify-center'>
                {upcoming.results.map(upcomingMovie => (
                    <MovieMediumCard key={upcomingMovie.id} upcomingMovieId={upcomingMovie?.id} poster_path={upcomingMovie.poster_path} title={upcomingMovie.title} vote_average={upcomingMovie.vote_average} overview={upcomingMovie.overview} />
                ))}
            </div>
        </div>
    )
